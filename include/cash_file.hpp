...
class cash_file {//объявляем наш класс
 public:
  cash_file() = default; //конструктор по умолчанию/Когда вызовем метод, дефолтный конструктор вызовет дефолтные контсрукторы у всех полей, а они делают пустые контейнеры
